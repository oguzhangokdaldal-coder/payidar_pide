...
PRODUCTS = [
    ...
    {"id": 7, "category": "pide", "name": "Peynirli Pide", "description": "Bol beyaz peynir ve maydanoz", "price": 150, "tag": "", "image": "img/peynirli_pide.jpg"},
    {"id": 8, "category": "pide", "name": "Kıymalı Kaşarlı Pide", "description": "İnce kıyma ve bol kaşar bir arada", "price": 170, "tag": "", "image": "img/kiymali_kasarli_pide.jpg"},
    {"id": 9, "category": "pide", "name": "Kuşbaşılı Pide", "description": "Zırh kuşbaşı, domates ve biber", "price": 180, "tag": "", "image": "img/kusbasili_pide.jpg"},
    {"id": 10, "category": "pide", "name": "Sade Kıymalı Pide", "description": "Bol kıyma, sade ve doyurucu", "price": 250, "tag": "", "image": "img/sade_kiymali_pide.jpg"},

    {"id": 11, "category": "izgara", "name": "Şiş Köfte", "description": "Izgara ateşinde közlenmiş şiş köfte", "price": 300, "tag": "", "image": "img/sis_kofte.jpg"},
    ...
    {"id": 13, "category": "izgara", "name": "Izgara Köfte", "description": "El yapımı ızgara köfte", "price": 300, "tag": "", "image": "img/izgara_kofte.jpg"},
    {"id": 14, "category": "izgara", "name": "Tavuk Şiş", "description": "Marine edilmiş tavuk şiş", "price": 300, "tag": "", "image": "img/tavuk_sis.jpg"},

    {"id": 15, "category": "durum", "name": "Adana Dürüm", "description": "Adana kebap, lavaş içinde sarılır", "price": 300, "tag": "", "image": "img/adana_durum.jpg"},
    {"id": 16, "category": "durum", "name": "Tavuk Dürüm", "description": "Marine tavuk şiş, lavaş içinde sarılır", "price": 300, "tag": "", "image": "img/tavuk_durum.jpg"},
    {"id": 17, "category": "durum", "name": "Şiş Köfte Dürüm", "description": "Şiş köfte, lavaş içinde sarılır", "price": 300, "tag": "", "image": ""},

    {"id": 18, "category": "icecek", "name": "Yayık Ayran", "description": "Günlük yoğurttan, buz gibi", "price": 45, "tag": "", "image": "img/ayran.jpg"},
    {"id": 19, "category": "icecek", "name": "Kutu Kola", "description": "330 ml, buz gibi", "price": 40, "tag": "", "image": "img/kutu_kola.jpg"},
    {"id": 20, "category": "icecek", "name": "Fanta", "description": "330 ml, buz gibi", "price": 40, "tag": "", "image": "img/fanta.jpg"},
    {"id": 21, "category": "icecek", "name": "Sprite", "description": "330 ml, buz gibi", "price": 40, "tag": "", "image": "img/sprite.jpg"},
    {"id": 22, "category": "icecek", "name": "Soda", "description": "200 ml, sade", "price": 25, "tag": "", "image": ""},
    {"id": 23, "category": "icecek", "name": "Şalgam Suyu", "description": "Acılı, geleneksel usul", "price": 35, "tag": "", "image": "img/salgam.jpg"},
    {"id": 24, "category": "icecek", "name": "Çay", "description": "Demlik çaydanlıktan, ince belli bardakta", "price": 20, "tag": "", "image": "img/cay.jpg"},
]
